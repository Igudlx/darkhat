...
async function initAuth() {
  ...
  const { auth, AuthLib } = fb();
  // "Local" persistence stores the session in this browser's own storage,
  // independent of the browser's own password-save popup — it survives
  // refresh and reopening the tab, and only clears on explicit sign-out.
  try {
